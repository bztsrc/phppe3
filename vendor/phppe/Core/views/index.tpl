...
<tr><td>Data domain:</td><td dir='ltr'><!if core.lib('DS').name><span style="color:green;"><!=core.lib('DS').name></span><!else><span style="color:blue;">files</span><!/if>
</td><td class='comment'>
...
<tr><td dir='ltr'>&lt;!foreach core.lib()><br>&nbsp;&nbsp;&lt;!=IDX>(&lt;!=ODD>)&lt;!=KEY>:&lt;!=name>&lt;br><br>&lt;!/foreach><br><br></td><td><!foreach core.lib()><!=IDX>(<!=ODD>) <!=KEY>:<!=name><br><!/foreach></td><td class='comment'>Example iteration on an array of objects</td></tr>
...
<tr><td dir='ltr'>&lt;!if !core.noframe><br>&nbsp;&nbsp;&lt;!foreach core.lib()><br>&nbsp;&nbsp;&nbsp;&nbsp;&lt;!if ODD><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!=KEY>, &lt;!foreach strings>&lt;!=KEY>&lt;!/foreach><br>&nbsp;&nbsp;&nbsp;&nbsp;&lt;!else><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!foreach core.js>&lt;!=KEY>,&nbsp;&lt;!=parent.KEY>&lt;!/foreach><br>&nbsp;&nbsp;&nbsp;&nbsp;&lt;/if><br>&nbsp;&nbsp;&lt;!/foreach><br>&lt;!else>should not see this&lt;!/if></td><td>
<!if !core.noframe>
  <!foreach core.lib()>
...
<table>
<tr><td dir='ltr'>&lt;!=core.base></td><td><!=core.base></td><td class='comment'>Output the value of a field of an object</td></tr>
...
<tr><td dir='ltr'>&lt;!if core.isTry()>&lt;!dump core.req2arr('obj')>&lt;!/if></td><td><!if core.isTry()><!dump core.req2arr('obj')><!/if></td><td class='comment'>Built-in object dumper for debugging. Press the OK button below the form to see it in action.</td></tr>
...
<tr><td dir='ltr'>&lt;!field text(<span title='maxlength'>32</span>) obj.field2 - - - search></td><td><!field text(32) obj.field2 - - - search></td><td class='comment'>Reads more than meets the eye with &quot;fake&quot; value</td></tr>
<tr><td dir='ltr'>&lt;!field text(<span title='maxlength'>80</span>,<span title='rows'>2</span>)  obj.field3></td><td><!field text(80,2) obj.field3></td><td class='comment'>You don't have to know about textarea, just add the number of rows you want</td></tr>
...
<tr><td dir='ltr'>&lt;!field select(<span title='size'>3</span>,<span title='is multiple'>1</span>) obj.field5 <span title='list values'>core.addon()</span>></td><td><!field select(3,1) obj.field5 core.addon()></td><td></td></tr>
...
<tr><td dir='ltr'>&lt;!field num(0,9999) obj.field14></td><td><!field num(0,9999) obj.field14></td><td class='comment'>Reads number up till 9999</td></tr>
<tr><td dir='ltr'>&lt;!field num(100,9000) obj.field15></td><td><!field num(100,9000) obj.field15></td><td class='comment'>On the fly boundary check</td></tr>
...
<tr><td dir='ltr'>&lt;!field checklist(1,2,3,4,5) obj.field17 <span title='list values'>core.addon()</span>></td><td><!field checklist(1,2,3,4,5,6,7) obj.field17 core.addon()></td><td class='comment'>A checklist implemented as field plugin</td></tr>
<!/if>
<!if core.isinst('rs')>
...
<tr><td dir='ltr'>&lt;!field combo obj.field19 <span title='list values'>core.addon()</span>></td><td><!field combo obj.field19 core.addon()></td><td class='comment'>Combo Box. Select "Other" for text mode, press down arrow or backspace with empty value to return.</td></tr>
<!/if>
<tr><td dir='ltr'>&lt;!field color obj.field20></td><td><!field color obj.field20></td><td class='comment'>colorpicker</td></tr>
...
<tr><td dir='ltr'>&lt;!field boolean obj.field21></td><!if !core.isinst('boolean')><td><span style="background:#F00000;color:#FFA0A0;padding:3px;"><!=L("Not found")> boolean</span></td><!else><td><!field boolean obj.field21><!/if></td><td></td></tr>
<tr><td dir='ltr'>&lt;!field boolean(true,'Enabled','Disabled') obj.field22></td><!if !core.isinst('boolean')><td><span style="background:#F00000;color:#FFA0A0;padding:3px;"><!=L("Not found")> boolean</span></td><!else><td><!field boolean(true,'Enabled','Disabled') obj.field23><!/if></td><td></td></tr>
<tr><td dir='ltr'>&lt;!field notboolean obj.field23></td><!if !core.isinst('notboolean')><td><span style="background:#F00000;color:#FFA0A0;padding:3px;"><!=L("Not found")> notboolean</span></td><!else><td><!field notboolean obj.field23><!/if></td><td></td></tr>
<tr><td dir='ltr'>&lt;!field setsel obj.field24 core.addon()></td><!if !core.isinst('setsel')><td colspan='2'><span style="background:#F00000;color:#FFA0A0;padding:3px;"><!=L("Not found")> setsel</span></td><!else><td colspan='2'><!field setsel obj.field24 core.addon()><!/if></td></tr>
