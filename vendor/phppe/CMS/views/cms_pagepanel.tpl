...
<span id='pageresp'><!cms pageresp Resolutions></span><span><!cms pagemeta Meta></span><span><!cms pagedds Dynamic_Data_Sets></span><!if core.lib("CMS").revert><span><!cms pagehistory Page_history></span><!/if><span><!cms pagedelete Delete_page></span><span><!cms pageadd Clone_page></span><span><img src='images/cms/accept.png' title="<!L Save>" style='position:absolute;z-index:998;' onclick='document.location.href="<!=core.item>";'></span>
<!else>
