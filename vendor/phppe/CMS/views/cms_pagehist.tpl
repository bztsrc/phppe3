...
<div class='infobox'>
<!foreach param>
<img src='images/cms/pagedelete.png' alt='[Delete]' title='<!=L("pagedel")>' style='vertical-align:middle;float:left;padding:2px;z-index:10;' onclick='if(confirm(L("sure"))) return document.location.href="<!=url("cms","pagepurge")+""+urlencode(id)>";'>
