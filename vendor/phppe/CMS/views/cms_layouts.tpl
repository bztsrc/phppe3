...
<button onclick='pe.cms.edit(this,"f95f1f92080432dc901529d428fd32fa12d7b948",0,0,0,0,0,80);' class='btn'><span class='glyphicon glyphicon-plus-sign'></span>&nbsp;<!=L("layoutadd")></button>
...
<div id='layoutdiv'>
<!form layout>
<input type='hidden' id='layout_delete' value='0'>
...
<div class='toolbar'><!field button Delete pe.cms.layoutdel(event)><!field button Info pe.cms.fieldset(event)><!field update Save></div>
</form>
<!/if>
