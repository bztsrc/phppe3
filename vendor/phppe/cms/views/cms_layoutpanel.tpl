<!if !empty(core.item)>
<span style='padding-right:10px;'><a href='<!=url("cms","layouts")>'><img src='images/cms/home.png' style="position:absolute;"></a><span></span></span>
<span style='padding-right:5px;'><img style="position:absolute;" onclick="cms_layoutdelete(this,&quot;layoutdelete&quot;,1);" src="images/cms/layoutdelete.png" alt="[LAYOUTDELETE <!=htmlspecialchars(L('Delete layout'))>]" title="<!=htmlspecialchars(L('Delete layout'))>"><span></span></span>
