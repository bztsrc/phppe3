...
INSERT INTO `pages` VALUES ('frame','','','','frame','','{"mainmenu":["b.*", "pages_list a left join pages b on a.page_id=b.id and b.created=(SELECT MAX(c.created) FROM pages c WHERE c.id=b.id)", "a.parent_id=''''", "", "a.list_id,ordering"]}','',0,0,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,0,0,-1);
...
INSERT INTO `pages` VALUES ('cmstest/2','','Test Page #2','','simple','{"body":"test2","meta":{}}','','',0,0,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,0,0,-1);
INSERT INTO `pages_list` VALUES ('mainmenu','','cmstest',0);
INSERT INTO `pages_list` VALUES ('mainmenu','','cmstest/2',0);
